...
def ensure_model():
    if not MODEL_PATH.exists():
        ...
        print("  Descargando macOS UI Elements...")
        hf_hub_download(repo_id="macpaw-research/yolov11l-ui-elements-detection",
...
def run(image_path, output_dir=None):
    ...
    return run_model(model, img, "macos", 0.3, image_path, output_dir)
